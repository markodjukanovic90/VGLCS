...
\begin{frame}{Problem definition}
   ...
   \begin{definition}[The multiple (variable) gapped LCS problem]
...
\begin{frame}{Literature \& Motivation}
   ...
   \begin{itemize}
       \item  Peng and Yang (2014): studied the problem with $m=2$ (poly-version): \textbf{Three dynamic programming} approaches (basic and sparse ones, advanced data-structures)
   ...
   \begin{itemize}
       ...
       \item \textbf{Time-series analysis}:  especially in settings where events are required to occur within specified temporal delays~\cite{lainscsek2015delay}
   \end{itemize}
