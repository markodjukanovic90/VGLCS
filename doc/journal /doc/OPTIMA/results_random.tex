...
\begin{table}[t]
	\centering
	\caption{Comparison of objective values between IMSBS and LIMSBS on benchmark set \textsc{Random}. Best results per instance category are displayed in bold.}
	...
	\begin{minipage}{0.4\textwidth}
		...
		\scalebox{0.8}{
			\begin{tabular}{ccc|cc}
				\hline
				$m$ & $n$ & $|\Sigma|$ & LMSBS-ensemble & IMSBS \\ \hline
