...
void Instance::fill_in_data_structures()
{
    ...
    // TODO occurances_string_pos_char --> revert j indices from the largest to 0 ?? 
    ...
    // std::cout <<    "Embed structure ... " <<  this->p << std::endl;
    for(int i = 0; i < this->m; ++i)
    {
