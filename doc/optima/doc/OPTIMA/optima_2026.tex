...
After extensive empirical evaluation, the following NN configurations are selected for the \textsc{Random} benchmark:
\begin{itemize}
	\item $m=2$: architecture (10, 5, 5), activation \texttt{ReLU}, features $F_2$;
	\item $m=3$: architecture (10, 10, 5), activation \texttt{ReLU}, features $F_2$;
	\item $m=5$: architecture (10, 5, 5), activation \texttt{sigmoid}, features $F_1$;
	\item $m=10$: architecture (10, 5, 5), activation \texttt{ReLU}, features $F_2$.
\end{itemize}
