...
\begin{figure}[!ht]
	...
	\caption{Visualization of results for $\alpha$ tuning: $m=3$  (left), and $m=5$ (right).}
...
\begin{itemize}
	\item  Out of 32 instances, \textsc{Limsbs-ensemble} achieves better performance over \textsc{Imsbs} in 20 cases, ties occur in 8 cases, and in only 4 cases the winner is \textsc{Imsbs}.
...
\begin{itemize}
	\item \textit{Solution quality.} \textsc{Limsbs-ensemble} outperforms \textsc{Imsbs} in 7 out of 20 instances, with the remaining 13 resulting in ties. No instance favors \textsc{Imsbs}. %, indicating consistent superiority of the proposed method.
