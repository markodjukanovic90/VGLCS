...
\begin{figure}[!ht]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth,height=90pt]{alpha_param_m10.png}
		%\caption*{$m=10$}
	\end{minipage}
	
	\caption{Visualization of parameter $\alpha$ tuning for different instance sizes ($m=3$ case (left), and $m=10$ case (right)).}
...
\begin{itemize}
	\item  Out of 32 instances, \textsc{Limsbs-ensemble} achieves better performance over \textsc{Imsbs} in 20 cases, ties occur in 7 cases, and in only 5 cases the winner is \textsc{Imsbs}.
