...
We agree that gradient-based methods may be more robust methodology for tuning parameter of neural network. However, in our case it turned out not of a particular help according to our preliminary test even for these small-sized NNs. Thus, we switched to GA which did the job. We mention what suggested in the abstract. 
...
This is a good comment. We decided to mention it as a promising idea to be exploited in future work. 
...
We have added proper naming hare and a few lines of pseudocode are updated to support the clear presentation. 
...
These are two set of different instances, associated with the original instances.
