...
\begin{frame}{The gapped LCS problem (Peng and Yang, 2012)}
   ...
   \begin{definition}[A gapped subsequence]
         ...
         \begin{itemize}
         	\item consecutive embedding positions respect gap distances (not more than \textcolor{red}{allowed number of letters} inbetween)
...
\begin{frame}{Literature \& Motivation for VGLCSP}
   ...
   \begin{itemize}
       ...
       \begin{itemize}
        ...
        \end{itemize} 
        \item Djukanovic et al. (2026): the first approach for general VGLCSP ($m$ arbitrary): \textcolor{red}{Iterative Beam search approach}
...
\small
For a state $\textbf{v}=(\mathbf p^v,l^v)$ ($p^v$: vector of sufix positions of subproblem to be solved, $l^v$: lenght of partial solution), build a size-independent features:
\vspace{0.2cm}
\begin{columns}[T,totalwidth=\textwidth]
