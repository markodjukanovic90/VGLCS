...
\begin{itemize}
  ...
  \item Search quality is non-differentiable: one ranking decision  affect many later states.
  \item Exact optimal trajectories are unavailable for the general multi-sequence case.
\end{itemize}
\end{block}
\end{column}
\begin{column}{0.48\textwidth}
...
\midrule
LIMSBS-Ensemble vs. IMSBS & 12 & 7 & 1\\
\bottomrule
\end{tabular}} \\
\vspace{0.15cm}
